...
(хочу объяснить причину "лишних" функций и функциональных требований. Изначально при выборе темы не обратила внимания на Ваше сообщение в телеграмме с объяснением некоторых тем. Поняла тему так: управление уже готовыми баннерами без помощи специалистов-разработчиков, чтобы маркетолог мог самостоятельно без навыков программирования загружать баннеры, изменять информацию о них, настраивать таркетинг и т.д. Но незадолго до срока прикрепления отчета по курсовой увидела Ваше пояснение про парсинг данных и экспорт в Godot и решила усовершенствоаать раннее созданную программу благодаря созданию интерактивных баннеров, как следствие получила больше функциональных требований)
